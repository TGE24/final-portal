...
<!-- /Register Course -->                    
    ...
    while($userInfo = mysqli_fetch_array($results)):
         ?>
            ...
            <div class="col-md-3  ">                                     
        <input id="phone" name="choice[]" value="<?php echo $userInfo['course code'];?>" type="checkbox" class="form-control">
             </div> 
               </div> 
               <?php endwhile ;?>
         ...
         $regnum = getuserfield('regnum');
          if (isset($_POST['submit'])) {
             if(!empty($_POST['choice'])) {
              ...
              $query = "INSERT INTO `yr3_first_semestar_courses` (`regnum` ,`courseCode`) VALUES ('$regnum', '$courseCode')";
