...
$sql = "SELECT * FROM yr1_first_semestar_courses WHERE regnum = '$regnum'";
$results = $link->query($sql);
?>

<?php
$regnum = getuserfield('regnum');
$sql = "SELECT * FROM yr1_second_semestar_courses WHERE regnum = '$regnum'";
               ...
               <div class="">
                   ...
                   <div class="page-title">
                       <div class="title_left">
                           <h3>
                    Year One<br> <small>First Semester</small>
               </h3>
                       </div>
                           ...
                           <div class="x_panel">
                               <div class="x_content">
                                   ...
                                   <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                       <thead>
                                             <h3>
                                                Year One<br> <small>Second Semester</small>
                                              </h3>
                                           <tr class="headings">
