...
$sql = "SELECT * FROM yr3_first_semestar_courses WHERE regnum = '$regnum'";
$results = $link->query($sql);
?>

<?php
$regnum = getuserfield('regnum');
$sql = "SELECT * FROM yr3_second_semestar_courses WHERE regnum = '$regnum'";
               ...
               <div class="">
                   ...
                   <div class="page-title">
                       <div class="title_left">
                           <h3>
                   Year Three<br> <small>First Semester</small>
               </h3>
                       </div>
                               ...
                               <div class="x_content">
                                  ...
                                  <!-- <p>Add class <code>bulk_action</code> to table for bulk actions options on row select</p>-->
                                   ...
                                   <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                       <thead>
                                             <h3>
                                                Year Three<br> <small>Second Semester</small>
                                              </h3>
                                           <tr class="headings">
